...
Project led by Jackson Isenberg and the Alpharetta Robotics Club who is now busy at Georgia Institute of Technology.
Modernization effort by team Potential Energy 19706 (new gradle version, tests, updates to source) and now builds from Android Studio import.
> Things have been kept mostly the same in terms of structure, however we now use jitpack.io for distribution for ease of use.
...
[ ] Add more of WPILib's missing functionality
